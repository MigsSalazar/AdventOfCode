...
const neededSpace = 30000000 - (70000000 - sizes[getSizeIdx(homeDir)]);
const bestSize = Object.values(sizes)
	.filter(value => value >= neededSpace)
	.reduce((v1, v2) => Math.min(v1, v2), Infinity);
